...
VALUES
('plt-a-01', 'A-101', 'Sector A', '5 Marla', 'Residential', 4500000, 450000, 45000, 'Available', 'Underground Utilities, Near Central Park', '/images/sectors/sector-a-luxury.jpg', NOW()),
('plt-a-02', 'A-102', 'Sector A', '10 Marla', 'Residential', 8200000, 820000, 82000, 'Reserved', 'Main Boulevard, Underground Electrification', '/images/sectors/sector-a-luxury.jpg', NOW()),
('plt-a-03', 'A-105', 'Sector A', '1 Kanal', 'Residential', 15500000, 1550000, 155000, 'Available', 'Corner Plot, Park Facing, 60-ft Road', '/images/sectors/sector-a-luxury.jpg', NOW()),
('plt-b-01', 'B-201', 'Sector B', '5 Marla', 'Residential', 4500000, 450000, 45000, 'Available', 'Near Community Mosque, 40-ft Wide Road', '/images/sectors/sector-b-residential.jpg', NOW()),
('plt-b-02', 'B-205', 'Sector B', '10 Marla', 'Residential', 8200000, 820000, 82000, 'Available', 'Family Zone, Green Belt Adjacent', '/images/sectors/sector-b-residential.jpg', NOW()),
('plt-com-01', 'COM-01', 'Commercial Block', '4 Marla', 'Commercial', 18000000, 1800000, 180000, 'Available', 'Main GT Road Frontage, High Footfall Plaza Plot', '/images/sectors/commercial-plaza.jpg', NOW()),
('plt-com-02', 'COM-04', 'Commercial Block', '8 Marla', 'Commercial', 34000000, 3400000, 340000, 'Booked', 'Corporate Plaza Hub, Multi-Storey Approved', '/images/sectors/commercial-plaza.jpg', NOW())
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`);
